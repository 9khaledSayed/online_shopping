        ...
        <div class="row">
                ...
                <aside class="sidebar-left">
                    ...
                    <div class="sidebar-box">
                        ...
                        <ul class="thumb-list">
                            ...
                            <li>
                                <a href="#">
                                    <img src="img/our_coffee_miss_u_70x70.jpg" alt="Image Alternative text" title="Our Coffee miss u" />
                                </a>
                                <div class="thumb-list-item-caption">
            ...
            <div class="col-md-9">
                ...
                <div class="owl-carousel owl-slider" id="owl-carousel-slider" data-inner-pagination="true" data-white-pagination="true" data-nav="false">
                    <div>
                        <div class="bg-holder">
                            <img src="img/branding__ipad_interactive_design_900x500.jpg" alt="Image Alternative text" title="Branding  iPad Interactive Design" />
                    ...
                    <div>
                        <div class="bg-holder">
                            <img src="img/hot_mixer_900x500.jpg" alt="Image Alternative text" title="Hot mixer" />
                            <div class="bg-mask"></div>
                            <div class="bg-front vert-center text-white text-center">
                    ...
                    <div>
                        <div class="bg-holder">
                            <img src="img/iphone_5_ipad_mini_ipad_3_900x500.jpg" alt="Image Alternative text" title="iPhone 5 iPad mini iPad 3" />
                            <div class="bg-mask"></div>
                            <div class="bg-front vert-center text-white text-center">
